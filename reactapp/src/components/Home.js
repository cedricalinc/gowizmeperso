...
function Home(props) {
        ...
        //         }
                ...
                var cine = eventsList.map((x,i) => {
                        ...
                        return (       
                                <div key={i} class='carte' style={{ alignContent: 'center', padding:'15px'}}>
                                        <img onClick={() => {tokenOK();props.onAddIdEvent(x._id)}} src={x.image} alt={x.nom}/>
                                         
                                        {titre}
                                        <p style={{textAlign:"center"}}>{x.categories[0]}</p>
                ...
                var theatre = eventsList.map((w, i) => {
                        ...
                        return (       
                                <div key={i} class='carte' style={{ alignContent: 'center', padding:'15px'}}>
                                        <img onClick={() => {tokenOK();props.onAddIdEvent(w._id)}} src={w.image} alt={w.nom}/>
                                         
                                        {titre}
                                        <p style={{textAlign:"center"}}>{w.categories[0]}</p>
                                        <HeartFilled style={{ paddingLeft:"55px", marginLeft: '10px', fontSize: '18px', color: '#EFB509'}} />
                                        {/* <Icon type="message" style={{ fontSize: '16px', color: '#08c' }} theme="outlined" /> */}
                                </div>)}})
                ...
                var expos = eventsList.map((y, i) => {
                        ...
                        return (       
                                <div key={i} class='carte' style={{ alignContent: 'center', padding:'15px'}}>
                                        <img onClick={() => {tokenOK();props.onAddIdEvent(y._id)}} src={y.image} alt={y.nom}/>
                                         
                                        {titre}
                                        <p style={{textAlign:"center"}}>{y.categories[0]}</p>
                                        <HeartFilled style={{ paddingLeft:"55px", marginLeft: '10px', fontSize: '18px', color: '#EFB509'}} />
                                        {/* <Icon type="message" style={{ fontSize: '16px', color: '#08c' }} theme="outlined" /> */}
                                </div>)}})
        ...
        var concert = eventsList.map((z, i) => {
                if (z.type === 'concert') {
                        ...
                        return (       
                                <div key={i} class='carte' style={{ alignContent: 'center', padding:'15px'}}>
                                        <img onClick={() => {tokenOK();props.onAddIdEvent(z._id)}} src={z.image} alt={z.nom}/>
                                         
                                        {titre}
                                        <p style={{textAlign:"center"}}>{z.categories[0]}</p>
                                        <HeartFilled style={{ paddingLeft:"55px", marginLeft: '10px', fontSize: '18px', color: '#EFB509'}} />
                                        {/* <Icon type="message" style={{ fontSize: '16px', color: '#08c' }} theme="outlined" /> */}
                                </div>)}})
